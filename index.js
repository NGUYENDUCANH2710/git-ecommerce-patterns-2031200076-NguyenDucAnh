...
console.log("--- 2B: Factory Pattern ---");
const factory = new ProductFactory();
const book = factory.createProduct('book', { title: 'The Pragmatic Programmer', price: 35, author: 'Andy Hunt & Dave Thomas' });
const laptop = factory.createProduct('electronic', { model: 'XPS 15', price: 1500, brand: 'Dell' });
book.describe();
laptop.describe();
console.log("\n");
...
// Gỡ một observer và cập nhật lại
orderTracker.removeObserver(emailNotifier);
orderTracker.updateStatus('Shipped');
console.log("\n");
